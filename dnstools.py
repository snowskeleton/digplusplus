...
MX_PROVIDER_PATTERNS = [
    ...
    (re.compile(r"secureserver\.net", re.I), "GoDaddy Email"),
    (re.compile(r"privateemail\.com", re.I), "Namecheap Private Email"),
    (re.compile(r"emailsrvr\.com", re.I), "Rackspace Email"),
    (re.compile(r"kundenserver\.de|ionos\.com", re.I), "IONOS (1&1) Mail"),
    (re.compile(r"ovh\.net", re.I), "OVHcloud Mail"),
    (re.compile(r"dreamhost\.com", re.I), "DreamHost Mail"),
    (re.compile(r"yahoodns\.net", re.I), "Yahoo Small Business Mail"),
    (re.compile(r"your-server\.de", re.I), "Hetzner Mail"),
    (re.compile(r"bluehost\.com", re.I), "Bluehost (cPanel Mail)"),
    (re.compile(r"hostgator\.com", re.I), "HostGator (cPanel Mail)"),
]
...
NS_PROVIDER_PATTERNS = [
    ...
    (re.compile(r"worldnic", re.I), "Network Solutions"),
    (re.compile(r"name-services\.com", re.I), "eNom"),
    (re.compile(r"\bhover\.com", re.I), "Hover"),
    (re.compile(r"\bname\.com\b", re.I), "Name.com"),
    (re.compile(r"ui-dns", re.I), "IONOS (1&1)"),
    (re.compile(r"ovh\.net", re.I), "OVHcloud"),
    (re.compile(r"gandi\.net", re.I), "Gandi"),
    (re.compile(r"dnsmadeeasy", re.I), "DNS Made Easy"),
    (re.compile(r"dnsimple", re.I), "DNSimple"),
    (re.compile(r"easydns", re.I), "easyDNS"),
    (re.compile(r"nsone\.net", re.I), "NS1 (IBM)"),
    (re.compile(r"dynect\.net", re.I), "Oracle Dyn"),
    (re.compile(r"akam\.net", re.I), "Akamai"),
    (re.compile(r"ultradns", re.I), "Vercara (UltraDNS)"),
    (re.compile(r"digitalocean\.com", re.I), "DigitalOcean"),
    (re.compile(r"linode\.com", re.I), "Linode (Akamai)"),
    (re.compile(r"hetzner|your-server\.de", re.I), "Hetzner"),
    (re.compile(r"bluehost\.com", re.I), "Bluehost"),
    (re.compile(r"hostgator\.com", re.I), "HostGator"),
    (re.compile(r"dreamhost\.com", re.I), "DreamHost"),
    (re.compile(r"vultr\.com", re.I), "Vultr"),
    (re.compile(r"rackspace", re.I), "Rackspace"),
    (re.compile(r"shopify", re.I), "Shopify"),
    (re.compile(r"wixdns", re.I), "Wix"),
    (re.compile(r"dnspod", re.I), "DNSPod (Tencent Cloud)"),
    (re.compile(r"alidns|hichina", re.I), "Alibaba Cloud DNS"),
    (re.compile(r"cloudns\.net", re.I), "ClouDNS"),
]
